...
@Component({
  selector: 'app-list-adminstarteur',
  templateUrl: './list-adminstarteur.component.html',
  styleUrls: ['./list-adminstarteur.component.css']
})
export class ListAdminstarteurComponent implements OnInit {
  Employes: User[]=[];
  Nom!: string;
 ...
 idup:any;
  ...
  ngOnInit(): void {
    ...
    this.ser.getAllUser("Admin").subscribe(
      etudiant => {
